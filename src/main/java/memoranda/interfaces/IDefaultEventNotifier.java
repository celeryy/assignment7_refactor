...
public class IDefaultEventNotifier implements IEventNotificationListener {

	/**
	 * Constructor for DefaultEventNotifier.
	 */
	public IDefaultEventNotifier() {
		super();
	}

	/**
	 * @see main.java.memoranda.interfaces.IEventNotificationListener#eventIsOccured(main.java.memoranda.interfaces.AEvent)
	 */
	public void eventIsOccured(AEvent ev) {		
