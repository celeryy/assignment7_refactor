...
/*			_root.addNamespaceDeclaration("jnevents", NS_JNEVENTS);
	...
	public static AEvent createEvent(
		CalendarDate date,
		int hh,
		int mm,
		String text) {
	...
	public static AEvent createRepeatableEvent(
		int type,
	...
	public static AEvent getEvent(CalendarDate date, int hh, int mm) {
		Day d = getDay(date);
		if (d == null)
			return null;
		Elements els = d.getElement().getChildElements("event");
	...
	public static void removeEvent(AEvent ev) {
